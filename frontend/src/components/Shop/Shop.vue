...
<script>
    ...
    export default {
        ...
        mounted() {
            let res =
                {
                    'success': true, 'message': 'success', 'code': 200, 'timestamp': 1597812544781, 'result': [{
                        'id': 7,
                        'name': '轮播图',
                        'type': 0,
                        'sortOrder': 0,
                        ...
                        'panelContents': [{
                            ...
                            'sortOrder': 2,
                            'fullUrl': '',
                            'picUrl': 'https://i.loli.net/2020/07/24/6BV9uTwaqModbYL.png',
                            'picUrl2': null,
                            'picUrl3': null,
                            ...
                            'productName': '捐赠商品',
                            'subTitle': '您的捐赠将用于本站维护 给您带来更好的体验',
                            'productImageBig': 'https://i.loli.net/2020/07/24/6BV9uTwaqModbYL.png'
                        }]
                    }, {
                        'id': 2,
                        'name': '官方精选',
